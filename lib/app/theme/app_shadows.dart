...
class AppShadows {
  ...
  static BoxShadow get card => BoxShadow(
    color: const Color(0xFF344E41).withValues(alpha: 0.08),
    blurRadius: 24,
  ...
  static BoxShadow get light => BoxShadow(
    color: const Color(0xFF344E41).withValues(alpha: 0.05),
    blurRadius: 12,
  ...
  static BoxShadow get elevated => BoxShadow(
    color: const Color(0xFF344E41).withValues(alpha: 0.12),
    blurRadius: 32,
